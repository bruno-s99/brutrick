    ...
    def read_from_disk(self,queue):
        ...
        for ind, detection in enumerate(detections):
            ...
            if self.gaussian_bump:
                ...
                draw_gaussian(heatmaps_tl[:,:,0], [xtl, ytl], radius)#statt 0 category
                draw_gaussian(heatmaps_br[:,:,0], [xbr, ybr], radius)#statt 0 category
            else:
...
if __name__=='__main__':
    ...
    data.inupt_producer()
    images, tags_tl, tags_br,heatmaps_tl, heatmaps_br, tags_mask, offsets_tl, offsets_br,boxes,ratio=data.get_batch_data(5)#2
