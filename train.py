...
class Train():
    ...
    def train_mult(self):
        ...
        lr=tf.compat.v1.train.exponential_decay(self.lr,steps,self.decay_step,self.decay_rate,staircase= True, name= 'learning_rate')
    ...
    def train_single(self):
        ...
        update=tf.compat.v1.get_collection(tf.compat.v1.GraphKeys.UPDATE_OPS)
        #with tf.control_dependencies(update):
        train_op=tf.compat.v1.train.AdamOptimizer(learning_rate=lr).minimize(loss,steps)
