...
class Image_data():
    ...
    def get_single_data(self,queue):
        images, tags_tl, tags_br,heatmaps_tl, heatmaps_br, tags_mask, offsets_tl, offsets_br,boxes,ratio=tf.compat.v1.py_func(self.read_from_disk,[queue],
    ...
    def get_batch_data(self,batch_size):
        images, tags_tl, tags_br,heatmaps_tl, heatmaps_br, tags_mask, offsets_tl, offsets_br,boxes,ratio=tf.compat.v1.train.shuffle_batch([self.images,
